        ...
        <Button
          ...
          onClick={() => {
            toast("Что умеет сайт", {
              description: "1. Поиск по номеру заявки\n2. Поиск по серийному номеру\n3. Статистика (код 2218)\n4. График заявок по дням\n5. Список ожидания запчастей\n6. Повторные заявки\n7. Фильтр по исполнителю\n8. Фильтр по периоду\n9. Тёмная тема\n10. Очистка поиска (Esc)\n11. Загрузка отчёта\n12. Удаление данных",
              duration: 10000,
            });
          }}
